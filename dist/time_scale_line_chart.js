(function() {
  ...
  define(['underscore', 'src/line_chart_builder'], function(_, LineChart) {
    var TimeScaleLineChart;
    TimeScaleLineChart = (function(_super) {
    ...
    return window.TimeScaleLineChart = TimeScaleLineChart;
  });
